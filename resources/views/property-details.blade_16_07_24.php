...
@section('content')
        ...
        <div class="container-fluid parent-div p-0 propertyDetails">
            ...
            <div class="container Awesome-Interior pt-3">
                ...
                <div class="right text-end">
                    <div class="d-flex align-items-center gap-2 px-1 right-icons" style="background-color:  #f7f7ff; ">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-8 pro-left">
                        ...
                        <div class="address mt-5 pt-3" id="section2">
                            ...
                            <hr>
                            <div class="row mt-4">
                                <div class="col-12 col-sm address-col">
                                    ...
                                    <div class="listing-style5">
                                        <div class="list-thumb">
                                            <img src="{{ $listing['image_url'] }}"
                                                ...
                                                onerror="this.src='{{ $frontendUrl }}/images/no_image.jpg';">
                            ...
                            <div class="list-price mb-2">
                                ...
                                @endif
                                            ...
                                            @if (empty($listing['StreetNumber']) && empty($listing['StreetName']))
                                                <h6 class="list-title">
                                                    <a href="{{ env('BASE_URL') }}/property-detail/{{ $listing['slug_url'] ?? $listing['ListingId'] }}">{{ $listing['City'] }}, {{ $listing['StateOrProvince'] }}</a>
                                                </h6>
                                            @else
                                                <h6 class="list-title">
                                                    <a href="{{ env('BASE_URL') }}/property-detail/{{ $listing['slug_url'] ?? $listing['ListingId'] }}">
                                                        {{ $listing['StreetNumber'] }} {{ $listing['StreetName'] }} {{ $listing['StreetSuffix'] }}, {{ $listing['City'] }}, {{ $listing['StateOrProvince'] }}
                                                    </a>
                                                </h6>
                                            @endif
                                            <p class="list-text">{{ $listing['PropertyType'] }}</p>
                                            <div class="list-meta d-flex align-items-center gap-3"></div>
                    ...
                    <div class="col-12 col-md-4 px-1 sticky-wrapper">
    ...
    font-size: 10px;"
                                                ...
                                                data-bs-target="#staticBackdrop">Contact REALTOR®</button>
                                        </div>
                                    </div>
            ...
            <script>
                ...
                function scrollToSection(sectionId) {
                    ...
                    if (section) {
                        const offset = 60; // Set your desired offset in pixels
    ...
    document.querySelector('.price').textContent = `$${formattedListPrice}`;
            ...
            if ("{{ $propertyDetails['StreetNumber'] }}" !== '' || "{{ $propertyDetails['StreetName'] }}" !==
                ...
                if ("{{ $propertyDetails['StreetSuffix'] }}" !== '') {
                    headingText +=
                        "{{ $propertyDetails['StreetNumber'] }} {{ $propertyDetails['StreetName'] }} {{ $propertyDetails['StreetSuffix'] }}";
                } else {
...
$('.heading').text(headingText);
            ...
            var virtualTourImageUrl = "{{ $otherColumnsData['VirtualTourURLUnbranded'] }}";
            ...
            if (agentSlug.slug_url) {
                ...
                if (agentimage) {
                    imgElements.src = baseUrl + "/" + agentimage;
                } else {
