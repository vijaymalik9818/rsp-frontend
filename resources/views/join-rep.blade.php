                ...
                <div class="col-md-7">
                    <div class="d-flex flex-column justify-content-center">
                        ...
                        <p class="text-white text-shadow fs-6 join-sub">
                            ...
                            comprehensive REALTOR<span>&#174;</span> support network, and our low fee brokerage plans all geared to help
        ...
        <div class="row wow fadeInUp" data-wow-delay="300ms">
            <div class="col-lg-12 text-center">
                <h2 class='realtor-past-txt'>
                    REALTOR<span>&#174;</span> First - Past, Present and Future!
                </h2>
                <p class="text fz15 r-first-app">
                    We take a REALTOR<span>&#174;</span> First approach in everything we do. We support our associates <br> from start to
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <div class="carousel-caption  d-md-block">
                    ...
                    <h5>Kyle Winter, REALTOR<span>&#174;</span></h5>
            ...
            <div class="carousel-item ">
                <div class="carousel-caption  d-md-block">
                    ...
                    <h5>Ramesh Verma, REALTOR<span>&#174;</span></h5>
                    <p>I have been with Real Estate Professionals for 5 years and love working in this brokerage. Our
                        ...
                        REALTORS<span>&#174;</span> to come and join this awesome office.</p>
                </div>
            </div>
            ...
            <div class="carousel-item ">
                <div class="carousel-caption  d-md-block">
                    ...
                    <h5>Kelly Turner, REALTOR<span>&#174;</span></h5>
            ...
            <div class="carousel-item ">
                <div class="carousel-caption  d-md-block">
                    ...
                    <h5>Aurora Alipio, REALTOR<span>&#174;</span></h5>
            ...
            <div class="carousel-item ">
                <div class="carousel-caption  d-md-block">
                    ...
                    <h5>Cal Hanson, REALTOR<span>&#174;</span></h5>
                    <p>After starting my real estate career over 30 years ago with Canada’s largest real estate company
                        ...
                        learning and sharing their knowledge with their REALTORS<span>&#174;</span> to now offering mentoring to all new
                        and seasoned REALTORS<span>&#174;</span>. Whether you’re a new REALTOR<span>&#174;</span> or been a long time REALTOR<span>&#174;</span> overpaying at
            ...
            <div class="carousel-item ">
                <div class="carousel-caption  d-md-block">
                    ...
                    <h5>Martin Shahim, REALTOR<span>&#174;</span></h5>
            ...
            <div class="carousel-item ">
                <div class="carousel-caption  d-md-block">
                    ...
                    <h5>Lynn Brunton, REALTOR<span>&#174;</span></h5>
                    <p>The best Brokerage I have had the pleasure of working with in my 32 years as a REALTOR<span>&#174;</span>.  Real
                        ...
                        payouts and great office staff.  They offer a much-needed Mentorship program for new REALTORS<span>&#174;</span>
                        or those seasoned REALTORS<span>&#174;</span> that would like extra support in an area that they are not as
            ...
            <div class="carousel-item ">
                <div class="carousel-caption  d-md-block">
                    ...
                    <h5>Nadine Faule, REALTOR<span>&#174;</span></h5>
                    <p>After being in real estate for close to 35 years in very large franchises, I decided to slow down
                        ...
                        2019, this brokerage has grown considerably by offering new programs to new REALTORS<span>&#174;</span>,
                        mentorship, new websites and has also increased their social multimedia presence, without
                        increasing their fee structures.
                        Management has clearly demonstrated its dedication to their REALTORS<span>&#174;</span> well-being and success
            ...
            <div class="carousel-item ">
                <div class="carousel-caption  d-md-block">
                    ...
                    <h5>Rupi Sandhu, REALTOR<span>&#174;</span></h5>
            ...
            <div class="carousel-item ">
                <div class="carousel-caption  d-md-block">
                    ...
                    <h5>David Chapman, REALTOR<span>&#174;</span></h5>
                    <p>I have been associated with Real Estate Professionals for 8 years, moving from a small Boutique
                        ...
                        and what I had experienced since becoming a REALTOR<span>&#174;</span>.  With more than competitive fees,
            ...
            <div class="carousel-item ">
                <div class="carousel-caption  d-md-block">
                    ...
                    <h5>Robin Spiers, REALTOR<span>&#174;</span></h5>
                    <p>I joined Real Estate Professionals in 2003, and there’s many reasons why it’s the only Brokerage
                        I’ve ever been associated with. The competitive rates are attractive, especially for REALTORS<span>&#174;</span>
                        starting out – you can start with no monthly fees. There’s also a Mentorship Program, providing
                        guidance for those who want to learn from Calgary’s top producing REALTORS<span>&#174;</span>. Best of all, the
            ...
            <div class="col-lg-7 col-xl-6 wow fadeInLeft">
                <div class="cta-style3">
                    ...
                    <p class="cta-text mb25">
                        Fill in our REALTOR<span>&#174;</span> Intake Form to request a confidential meeting with a member of our management
                        staff where we will take you into a deep dive of Real Estate Professionals Inc.’s various
                        REALTOR<span>&#174;</span> First driven services and how we position you for success.
                    </p>
                        ...
                        <form class="form-style1" id="form-select">
                            <div class="row row-gap-3">
                                ...
                                <div class="col-md-6">
                                   ...
                                   <div class="col-md-6">
                                        <label class="heading-color ff-heading fw600 mb10">Are you currently a member/will be a member of a real estate board? If yes, please specify 
                                        (e.g., CREB<span>&#174;</span>, REALTORS<span>&#174;</span> Association of Edmonton, etc.).<span style="color: red;">*</span>
                                           </label>
                                        <div class="form-check d-flex gap-4 align-items-center">
                                            <div class="form-check d-flex align-items-center mb15">
                                                <input class="form-check-input" type="radio" name="real_estate_board" id="real_estate_yes"  value="yes" autocomplete="off">
                                                <label class="form-check-label" for="real_estate_yes">Yes</label>
                                            </div>
                                            <div class="form-check d-flex  align-items-center mb15">
                                                <input class="form-check-input" type="radio" name="real_estate_board" id="real_estate_no" value="no" autocomplete="off">
                                                <label class="form-check-label" for="real_estate_no">No</label>
                                            </div>
                                        </div>
                                        <div class="form-group" id="board_name_container" style="display: none;">
                                            <label class="heading-color ff-heading fw600 mb10">If yes, please let us know the name of the board(s)
                                                (e.g., CREB<span>&#174;</span>, REALTORS<span>&#174;</span> Association of Edmonton, etc.)<span style="color: red;">*</span></label>
...
var apiUrl = header + '/api/agents/join-rep-form';
    $('#form-select').validate({
        rules: {
            ...
            board_name: {
                required: function() {
                    return $('input[name="real_estate_board"]:checked').val() === 'yes';
                }
            }
        },
        messages: {
            ...
            real_estate_board: "Please select if you are a member of a real estate board.",
            is_contact: "Please select the best way to contact you.",
            board_name: "Please specify your real estate board."
        },
     ...
     // Handle the dynamic showing/hiding of the 'Board Name' input field
    $('input[name="real_estate_board"]').on('change', function() {
        if ($('input[name="real_estate_board"]:checked').val() === 'yes') {
            $('#board_name_container').show();
            $('#board_name').prop('required', true);  // Make the board name input required
        } else {
            $('#board_name_container').hide();
            $('#board_name').prop('required', false);  // Make the board name input not required
        }
    });
});
