...
.pac-container {z-index: 99999999999 !important;}
                ...
                <div class="col-lg-3">
                    <div class="dark-light-navtab style2 text-start text-lg-end mt-0 mt-lg-4 mb-4 ">
                        <div class="text-start text-lg-end mb-3">
                            <a class="ud-btn btn-outline-rep" href="/search/diamond">See All Diamond Listings<i
                    ...
                    <div class="why-chose-list">
                        <div class="list-one d-flex align-items-start mb30">
                            ...
                            <div class="list-content real-estate flex-grow-1 ml20">
                                ...
                                <p class="text mb-0 fz15">
                                    Relax and let our skilled Realtors<span class='r'>®️</span> navigate you through
                        ...
                        <div class="list-one d-flex align-items-start mb30">
                            ...
                            <div class="list-content real-estate  flex-grow-1 ml20">
                                ...
                                <p class="text mb-0 fz15">
                                      We're one of the largest INDEPENDENTLY OWNED real estate brokerage, with over 370 Realtors<span
                                        class='r'>®️</span> and have an internal network with trusted third-party vendors
                                    like property inspectors, lawyers, and mortgage brokers, all working together to help
                                    you market, sell, or purchase your dream home.
                                </p>
                            </div>
                        </div>
                        <div class="list-one d-flex align-items-start mb30">
                            ...
                            <div class="list-content real-estate  flex-grow-1 ml20">
                                ...
                                <p class="text mb-0 fz15">
                                    Leverage our extensive network of over 370 Realtors<span class='r'>®️</span>,
                                    across Calgary and the surrounding area. We employ a proactive, tech-savvy strategy to
                                    showcase your home on both our expanding brokerage platform and the MLS system<span
                                        class='r'>®️</span>, ensuring global visibility.
                                </p>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row wow fadeInUp align-items-center" data-wow-delay="00ms">
                ...
                <div class="col-lg-3">
                    <div class="dark-light-navtab style2 text-start text-lg-end mt-0 mt-lg-4 mb-4">
                        <div class="text-start text-lg-end mb-3">
                            <a class="ud-btn btn-outline-rep" target="_blank" href="/search/featured">See All Featured
                                Listings<i class="fal fa-arrow-right-long dark-color"></i></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="py90 bcg-primary py-5">
        <div class="container">
            ...
            <div class="row rep-style-3">
                ...
                <div class="col-md-6 col-lg-3 bt-floating">
    ...
    <section class="bgc-gray position-relative contact">
        ...
        <div class="container position-relative">
            ...
            <div class="row justify-content-between align-items-start cnct  h-0">
                <div class="col-md-5 col-lg-5 position-relative position-md-absolute top-left-300 office-north">
                        ...
                        <div class="inquiry-form">
                            ...
                            <div class="d-flex flex-column gap-2 addressSection">
                                ...
                                <p class="mb-0 d-flex gap-2">
                                    ...
                                    5403 Crowchild Trail NW Calgary, AB T3B 4Z1</a>
                                </p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-5 col-lg-5 position-relative position-md-absolute top-right-300 s-off">
                    <div class="home8-contact-form default-box-shadow1 bdrs12 bdr1 p30 mb30-md bgc-thm">
                        <div class="inquiry-form">
                            ...
                            <div class="d-flex flex-column gap-2 addressSection">
                                ...
                                <p class="mb-0 d-flex gap-2">
                                    ...
                                    5810 2nd Street SW Calgary, AB T2H 0H2</a>
                                </p>
                            </div>
                        </div>
                    </div>
...
function displaySuggestions(suggestedAgents, query) {
    ...
    Object.keys(categories).forEach(function(category) {
        if (categories[category].length > 0) {
            ...
            categories[category].forEach(function(suggestion, index) {
                ...
                // Add event listener for clicks on MLS ID suggestions
                if (category === 'MLS&#174; Number') {
                    ...
                    // Add event listener for clicks on Address suggestions (including postal codes)
                    suggestionElement.addEventListener('click', function() {
                        var slugUrl = suggestedAgents.slug_urls[index]; // Get the corresponding slug_url
      ...
      autocompleteInput.addEventListener('keydown', function(event) {
        ...
        if (suggestions.length > 0) {
            ...
            if (selectedIndex >= 0 && selectedIndex < suggestions.length) {
                ...
                autocompleteInput.value = suggestionText;
                suggestionList.innerHTML = '';
                // applyFilter('search', suggestionText); 
                autocompleteInput.dispatchEvent(new Event('change'));
    ...
    function navigateToSearchPage(query) {
        var formattedInput = query.toLowerCase().replace(/\s+/g, '-');
        window.location.href = '/search/' + formattedInput;
    }
   ...
   <span class="flaticon-like" id="fav-icon-${property.ListingId}" ></span>
                ...
                <div class="list-content">
                    <div class="list-price mb-2">${property.LeaseAmount ? 
            `${formatter.format(property.LeaseAmount)} / ${property.LeaseAmountFrequency} / ${property.LeaseMeasure}` : 
            `${formatter.format(property.ListPrice)}`}</div>
                    <h6 class="list-title">
