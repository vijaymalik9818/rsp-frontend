                            ...
                            <div class="filterSection position-relative">
                                ...
                                <div class="mid-sec row px-3">
                                    ...
                                    <div class="col-6 col-sm-3 col-md-3 mt-2 mt-sm-2 px-1">
                                        <button id="applyFiltersButton" class="ud-btn btn-primary w-100 applyFiltersButton">
                                            Search
                                        </button>
                                    </div>

                                    <div class="col-6 col-sm-3 col-md-3 mt-2 px-2" id="clearAll">
                                        <div class='d-flex reset-filter h-100 justify-content-start'>
                                            <button class='ud-btn btn-outline-rep bg-white w-100'
