...
@section('content')
                ...
                @foreach($administrativeTeams as $k => $singleTeam)
                    <div class="col-auto">
                        <div class="feature-style2 mb30">
                            ...
                            >
                                <img class="bdrs12" src="{{ asset('images/homebanner.jpg') }}" alt="" />
                            </div>
                            <div class="feature-content pt20">
                                <h6 class="title mb-1">{{ $singleTeam->name }}</h6>
                                <p class="text fz15">{{ $positions[$singleTeam->position] }}</p>
                            </div>
                        </div>
                                                ...
                                                >
                                                    <div class="container">
                                                        <div class="row align-items-center">
                                                            <div class="col-12">
                                                                <div
                                                                    class="agent-single d-sm-flex align-items-center"
                                                                >
                                                                    <div class="single-img mb30-sm">
                                                                        <img src="{{ asset('images/homebanner.jpg') }}" alt="" />
                                                                    </div>
                                                                    <div class="single-contant ml30 ml0-xs">
                                                                        <h2 class="title mb-0">{{ $singleTeam->name }}</h2>
                                                                        <p class="fz15">
                                                                            {{ $singleTeam->position_details }}
                                                                        </p>
                                                                        <div
                                                                            class="agent-meta mb15 d-md-flex align-items-center"
                                                                        >
                                                                            <!-- <a class="text fz15 pe-2 bdrr1" href="#"
                                                                              ><i
                                                                                class="fas fa-star fz10 review-color2 pr10"
                                                                              ></i
                                                                              >5.0 • 49 Reviews</a
                                                                            > -->
                                                                            <a class="text fz15 pe-2 ps-2 bdrr1" href="#"
                                                                            ><i class="flaticon-call pe-1"></i>{{ $singleTeam->phone }}</a
                                                                            >
                                                                            <a class="text fz15 ps-2" href="#"
                                                                            ><i class="flaticon-email pe-1"></i
                                                                                >{{ $singleTeam->email }}</a
                                                                            >
                                                                        </div>
                                                                        <div class="agent-social dark-icons">
                                                                            <a class="mr20" href="{{ $singleTeam->facebook_link }}"
                                                                            ><i class="fab fa-facebook-f"></i
                                                                                ></a>
                                                                            <a class="mr20" href="{{ $singleTeam->x_link }}"
                                                                            ><i class="fab fa-twitter"></i
                                                                                ></a>
                                                                            <a class="mr20" href="{{ $singleTeam->instagram_link }}"
                                                                            ><i class="fab fa-instagram"></i
                                                                                ></a>
                                                                            <a href="{{ $singleTeam->linkedin_link }}"
    ...
    <section class="bgc-gray">
        <div
            class="cta-banner3 mx-auto maxw1600 pt100 pt60-lg pb90 pb60-lg bdrs24 position-relative overflow-hidden mx20-lg"
        >
            <div class="container">
                <div class="row">
                    <div
            ...
            <div class="row">
                <div class="col-lg-6 m-auto wow fadeInUp" data-wow-delay="300ms">
                    <div class="main-title text-center">
                        <h2 class="title mb-4">Brokerage’s 3 Core Principals</h2>
                        <p class="paragraph">
    ...
    <!-- CTA Banner -->
    <section class="bcg-primary py-0">
        <div
