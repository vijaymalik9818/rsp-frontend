            ...
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-lg-2">
                    <div class="d-flex align-items-center justify-content-end">
                        ...
                        <div class="dropdown">
                            <button class="btn btn-custom dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="background-color: #10579f; color: white;">
                        ...
                        @else
                            ...
                            <a class="ud-btn btn-primary" data-bs-toggle="modal" href="#exampleModalToggle" role="button" onclick="openmodal()">Client Portal</a>
