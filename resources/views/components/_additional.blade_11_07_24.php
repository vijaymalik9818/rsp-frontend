        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" id="main-popup">
                ...
                <div class="modal-body">
                    ...
                    <h2>Welcome to Real Estate Professionals Inc.</h2>
                    <h6>Alberta's second-largest independently owned real estate brokerage platform</h6>
            ...
            <div class="modal-content" id="sign-in" style="display: none">
                ...
                <div class="modal-body">
                    <h2>Welcome to REAL ESTATE PROFESSIONALS</h2>
                    <h6>Alberta's second-largest independently owned real estate brokerage platform.</h6>
                    <p>Choose an option to sign in or create your REP account.</p>
                    ...
                    <div class="d-flex align-items-center justify-content-start">
                        ...
                        <div class="dropdown2">
                            <button class="btn btn-custom dropdown-toggle" type="button" id="dropdownMenuButton3"
                                ...
                                style="background-color: #10579f; color: white;">
                        ...
                        <a class="ud-btn btn-primary" data-bs-toggle="modal" href="#exampleModalToggle" role="button"
